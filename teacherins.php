...
$sql="INSERT INTO teachers(teach_name,teach_sub,teach_degree)
VALUES
('$_POST[name]','$_POST[subject]','$_POST[degree]')";
...
<body style="background-color:#404B61; ">
   <center>
    ...
    <form method="POST" action="teacherins.php">
        <table border="1" height="150" bgcolor="#19A5D3">
           
            <tr><td>Name:<input type="text" placeholder="" required="" size="30" name="name"></td></tr>
            <tr><td>Subject:<input type="text" placeholder="" required="" size="30" name="subject"></td></tr> 
        <tr><td>Degree:<input type="text" placeholder="" required="" size="30" name="degree"></td></tr> 			
